A confusion matrix is a simple table used to measure how well a machine learning classification model is performing. Instead of just giving you a single number (like overall accuracy), it breaks down exactly where your model got things right and where it got "confused" between different categories.
